...
public class Utils {
    ...
    public static BigInteger toNanoCoins(String coins) {
        ...
        if (bigint.compareTo(BigInteger.valueOf(NetworkParameters.MAX_MONEY.getValue())) > 0)
            throw new ArithmeticException("Amount larger than the total quantity of Dash possible specified.");
        return bigint;
    }
